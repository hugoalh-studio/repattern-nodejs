...
function email(option) {
	...
	return $flagServiceGeneral(
		`(?<local>(?:${characterAlphanumeric}|${characterSymbolEmail})(?:\\.?(?:${characterAlphanumeric}|${characterSymbolEmail})){0,63})@(?<domain>${(typeof option.domain === "undefined") ? partDomain : option.domain.replace(/\./gu, "\\.")}${(option.ipv4 === true) ? `|\\[${partIPV4}\\]` : ""}${(option.ipv6 === true) ? `|\\[IPv6:${partIPV6}\\]` : ""})`,
		option
	);
};
/**
...
module.exports = {
	...
	blake384: hash384,
	blake512: hash512,
	colourCMYK: colourCMYK,
	colourHex: colourHex,
	colourHexAlpha: colourHexAlpha,
	colourHSL: colourHSL,
	colourHSLA: colourHSLA,
	colourHWB: colourHWB,
	colourHWBA: colourHWBA,
	colourNCol: colourNCol,
	colourRGB: colourRGB,
