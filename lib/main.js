...
function $checkCommonOption(option) {
	if (!advancedDetermine.isPlainObject(option, { configurableEntries: true, enumerableEntries: true, getterEntries: false, setterEntries: false, symbolKeys: false, writableEntries: true })) {
